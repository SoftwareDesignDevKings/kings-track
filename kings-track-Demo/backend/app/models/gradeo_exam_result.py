...
class GradeoExamResult(Base):
    __tablename__ = "gradeo_exam_results"
    __table_args__ = (UniqueConstraint("gradeo_exam_id", "gradeo_student_id", name="uq_gradeo_exam_result"),)
